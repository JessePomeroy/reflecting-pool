# Archived LumaPrints implementation spec — Reflecting Pool

> Historical pre-implementation specification. It includes superseded
> Sanity-order schemas, sample code, and TODOs. See
> [`../../LUMAPRINTS.md`](../../LUMAPRINTS.md) for the live integration.
