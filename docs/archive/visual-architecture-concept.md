# Archived visual architecture concept — Reflecting Pool

> Historical design concept for the original floating-gallery implementation.
> It conflicts with parts of the current application and is retained as visual
> design history only. See [`../../ARCHITECTURE.md`](../../ARCHITECTURE.md) for
